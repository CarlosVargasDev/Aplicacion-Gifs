...
export interface SearchResponseGifs {
    data:       Gifs[];
...
export class Convert {
    public static toSearchResponseGifs(json: string): SearchResponseGifs {
        return cast(JSON.parse(json), r("SearchResponseGifs"));
    }

    public static SearchResponseGifsToJson(value: SearchResponseGifs): string {
        return JSON.stringify(uncast(value, r("SearchResponseGifs")), null, 2);
    }
}
